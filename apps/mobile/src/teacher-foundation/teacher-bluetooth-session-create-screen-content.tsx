...
export function TeacherBluetoothSessionCreateScreenContent({
  ...
  if (phase === "error") {
    ...
    const isBluetoothOff =
      errText.toLowerCase().includes("turned off") ||
      errText.toLowerCase().includes("bluetooth is off")
    const isPermission =
      errText.toLowerCase().includes("permission") || errText.toLowerCase().includes("nearby")
      ...
      >
        ...
        <View style={{ marginTop: 28, gap: 10, alignItems: "center", width: "100%" }}>
          {canOpenSettings ? (
            ...
            >
              <Ionicons
                name={isBluetoothOff ? "bluetooth" : "settings-outline"}
                size={20}
