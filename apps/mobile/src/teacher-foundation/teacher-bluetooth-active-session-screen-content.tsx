...
function StudentRow({
  ...
  index,
  c,
}: { row: TeacherSessionRosterRowModel; index: number; c: ReturnType<typeof getColors> }) {
  ...
  return (
    <Animated.View entering={FadeInDown.duration(150).delay(index * 15)}>
      ...
      >
        ...
        >
          <Text
            style={{ fontSize: 12, fontWeight: "700", color: isPresent ? c.success : c.textSubtle }}
          >
...
export function TeacherBluetoothActiveSessionScreenContent({
  ...
  const isPermissionIssue =
    !isEnding && (runtimeErrorMessage?.toLowerCase().includes("permission") ?? false)
  const isFailed =
    !isEnding && (!runtimeAvailable || (runtimeErrorMessage != null && !isPermissionIssue))
  const hasBluetoothProblem = isPermissionIssue || isFailed
  const isBluetoothOff =
    !isEnding && (runtimeErrorMessage?.toLowerCase().includes("turned off") ?? false)
    ...
    return (
      ...
      >
        ...
        <Text style={{ fontSize: 14, color: c.textMuted, marginTop: 8 }}>
          Fetching Bluetooth session state…
        </Text>
      </View>
    )
  }
  ...
  return (
    <View style={{ flex: 1, backgroundColor: c.surface }}>
      ...
      >
        ...
        <Text
          style={{ fontSize: 22, fontWeight: "800", color: c.text, marginTop: 2 }}
          numberOfLines={1}
        >
          {classroomTitle}
        </Text>
      ...
      >
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
              ...
              <Text style={{ fontSize: 14, fontWeight: "700", color: c.danger, flex: 1 }}>
                {runtimeErrorMessage ||
                  (isFailed ? "Bluetooth advertising failed" : "Bluetooth permission needed")}
              </Text>
            </View>
        ...
        <View style={{ flexDirection: "row", paddingHorizontal: 24, gap: 10 }}>
          ...
          >
            <Text style={{ fontSize: 36, fontWeight: "800", color: c.success }}>
              {presentCount}
            </Text>
        ...
        >
          ...
          >
            ...
            <Text style={{ fontSize: 12, fontWeight: "600", color: c.textMuted }}>
              {rotationWindowSeconds}s rotation
            </Text>
          </View>
          <View
            style={{
          ...
          >
            <Ionicons
              name="radio-outline"
              size={13}
              color={isAdvertising ? c.success : c.textSubtle}
            />
            <Text
              style={{
                fontSize: 12,
                fontWeight: "600",
                color: isAdvertising ? c.success : c.textMuted,
              }}
            >
          ...
          <View style={{ flexDirection: "row", paddingHorizontal: 24, gap: 10, marginTop: 16 }}>
            {controlModel.canStart ? (
              ...
              >
                ...
                <Text style={{ fontSize: 15, fontWeight: "700", color: c.primaryContrast }}>
                  {controlModel.startLabel}
                </Text>
              </Pressable>
            ) : null}
                ...
                <>
                  ...
                  {liveRosterModel.absentRows.map((row, i) => (
                    <StudentRow
                      ...
                      row={row}
                      index={i + liveRosterModel.presentRows.length}
                      c={c}
                    />
                  ))}
                </>
        ...
        {endSessionErrorMessage ? (
          <View style={{ paddingHorizontal: 24, marginTop: 12 }}>
            <Text style={{ fontSize: 13, color: c.danger, textAlign: "center" }}>
              {endSessionErrorMessage}
            </Text>
          </View>
        ) : null}
