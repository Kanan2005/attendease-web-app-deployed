...
import { useTeacherClassroomDetailData, useTeacherCreateAnnouncementMutation } from "./queries"
    ...
    >
      ...
      <View style={as.section}>
        ...
        <View style={[as.card, { backgroundColor: c.surfaceRaised, borderColor: c.border }]}>
          ...
          <View style={{ flexDirection: "row", gap: 8 }}>
            <Pressable
              ...
              style={[
                as.toggle,
                {
                  borderColor: visibility === "TEACHER_ONLY" ? c.primary : c.border,
                  backgroundColor: visibility === "TEACHER_ONLY" ? c.primarySoft : c.surfaceMuted,
                },
              ]}
            >
              <Ionicons
                ...
                size={14}
                color={visibility === "TEACHER_ONLY" ? c.primary : c.textMuted}
              />
              <Text
                style={{
                  fontSize: 12,
            ...
            <Pressable
              ...
              style={[
                as.toggle,
                {
                  borderColor: visibility === "STUDENT_AND_TEACHER" ? c.primary : c.border,
                  backgroundColor:
                    visibility === "STUDENT_AND_TEACHER" ? c.primarySoft : c.surfaceMuted,
                },
              ]}
            >
              <Ionicons
                name="people-outline"
                size={14}
                color={visibility === "STUDENT_AND_TEACHER" ? c.primary : c.textMuted}
              />
              <Text
                style={{
                  fontSize: 12,
          ...
          <Pressable
            onPress={() => setShouldNotify((v) => !v)}
            style={{ flexDirection: "row", alignItems: "center", gap: 8, paddingVertical: 4 }}
          >
            <Ionicons
              name={shouldNotify ? "notifications" : "notifications-off-outline"}
              size={16}
              color={shouldNotify ? c.primary : c.textSubtle}
            />
            <Text
              style={{
                fontSize: 13,
                color: shouldNotify ? c.primary : c.textMuted,
                fontWeight: "600",
              }}
            >
          ...
          announcements.map((a, i) => {
            ...
            return (
              <Animated.View key={a.id} entering={FadeInDown.duration(200).delay(i * 30)}>
                <View
                  style={[as.feedCard, { backgroundColor: c.surfaceRaised, borderColor: c.border }]}
                >
                  <View
                    style={{
                      flexDirection: "row",
                  ...
                  >
                    ...
                    <View
                      style={[
                        as.visBadge,
                        { backgroundColor: isStudentVisible ? c.primarySoft : c.surfaceTint },
                      ]}
                    >
                      <Text
                        style={{
                          fontSize: 9,
                          fontWeight: "700",
                          color: isStudentVisible ? c.primary : c.textSubtle,
                        }}
                      >
