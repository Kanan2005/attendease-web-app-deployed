  ...
  await Promise.all([
    transaction.studentProfile.upsert({
      ...
      update: {
        ...
        degree: studentFixtures.studentOne.degree,
        branch: studentFixtures.studentOne.branch,
    ...
    transaction.studentProfile.upsert({
      ...
      update: {
        ...
        degree: studentFixtures.studentTwo.degree,
        branch: studentFixtures.studentTwo.branch,
    ...
    transaction.studentProfile.upsert({
      ...
      update: {
        ...
        degree: studentFixtures.studentThree.degree,
        branch: studentFixtures.studentThree.branch,
    ...
    transaction.studentProfile.upsert({
      ...
      update: {
        ...
        degree: studentFixtures.studentFour.degree,
        branch: studentFixtures.studentFour.branch,
