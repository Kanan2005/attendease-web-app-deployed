...
| **Web** | https://attendeaselive.xyz | `Kanan2005/attendease-web-app-deployed` | `main` |
...
- `attendease-mnit` — **active**, custom domain `attendeaselive.xyz`
...
curl -s -o /dev/null -w "%{http_code}\n" https://attendeaselive.xyz/admin/teachers
