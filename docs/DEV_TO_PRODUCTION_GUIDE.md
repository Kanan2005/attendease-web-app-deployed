...
|----------|----------------|-----------------|
| `NEXT_PUBLIC_APP_URL` | `http://127.0.0.1:3000` | `https://attendeaselive.xyz` |
...
| `API_CORS_ALLOWED_ORIGINS` | `http://localhost:3000,http://127.0.0.1:3000,http://192.168.29.11:3000` | `https://attendeaselive.xyz,https://www.attendeaselive.xyz,http://localhost:3000` |
