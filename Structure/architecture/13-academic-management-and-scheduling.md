...
Code-layout, testing, and rollout notes now live in
[`./13-academic-management-and-scheduling-notes.md`](./13-academic-management-and-scheduling-notes.md)
so this main doc can stay centered on domain boundaries and CRUD behavior.
