...
20. `20-product-reset-micro-prompts.md`
   - supported by:
     - `20-product-reset-prompts-01-10.md`
     - `20-product-reset-prompts-11-20.md`
     - `20-product-reset-prompts-21-30.md`
     - `20-product-reset-prompts-31-40.md`
...
- `20-product-reset-micro-prompts.md` -> prompt-pack index for the reset track, with the actual prompt bodies split across the four `20-product-reset-prompts-*.md` companion docs
